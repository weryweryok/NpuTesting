...
public class ScenariesTest {
    ...
    public void BuyTshirtAndCheckingPriceTest(){
        ...
        actualPrice = Double.valueOf(webDriver
                .findElement(By.xpath("//*[@id=\"product_price_1_1_326656\"]/span"))
                .getText()
                .substring(1));//Убираем знак "$"

        Assert.assertEquals(expectedPrice,actualPrice);

        webDriver.findElement(By.xpath("//*[@id=\"product_1_1_0_326656\"]/td[5]/input[2]")).clear();
        webDriver.findElement(By.xpath("//*[@id=\"product_1_1_0_326656\"]/td[5]/input[2]")).sendKeys("2");
